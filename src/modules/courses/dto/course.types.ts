...
export const allFields =
  'uri title subtitle content template order duration category sections media price currency rating numberOfRatings audienceFit objectives instructor isPublic isBestSeller isDraft isFeatured isRemoved publishedAt updatedAt createdAt';
export const adminBasicFields = 'uri title order duration category instructor isPublic publishedAt';
export const basicFields =
  'uri title subtitle content order duration category media attachments price audienceFit objectives instructor isPublic isFeatured publishedAt';
