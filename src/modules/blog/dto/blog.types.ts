...
export const allFields = 'uri title subtitle content template order link media readingTime isDraft isRemoved isRemovable isPublic publishedAt updatedAt createdAt';
